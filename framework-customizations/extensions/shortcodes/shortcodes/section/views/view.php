...
<section <?php if(!empty($atts['custom_id'])): ?>id="<?php echo esc_attr($atts['custom_id']); ?>"<?php endif; ?> class="<?php echo esc_attr($section_extra_classes) ?>" <?php echo $section_style; ?> <?php echo $bg_video_data_attr; ?>>
		<div class="<?php echo  esc_attr($conclass); ?>">
			<?php if(isset($atts['make_wrap_row']) && $atts['make_wrap_row']==1): ?>
			<div class="<?php if(isset($atts['wrap_class'])){echo $atts['wrap_class'];}else{echo 'row';} ?>">
				<?php endif; ?>
					<?php if(isset($atts['include']) && $atts['include'] ==1){
