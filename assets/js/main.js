    ...
    jQuery(document).ready(function ($) {
       ...
       // $('.book-now-btn').on('click',bookCar);
		...
		$('.section-title').each(function () {
			...
			span_icon.appendTo(title_line);
			var fCh = $(this).children('h2');
			var lCh = $(this).children('p');
			$(this).append(fCh);
			$(this).append(title_line);
			$(this).append(lCh);
		});
		var div = $('<div />',{
			id:'mobileapp-video-bg',
			class:'isMuted'
		});
		$('section').before(function(indx){
			if($(this).attr('id')=='mobile-app-area'){
				return div;}
			else{
				return '';}
		});
	/*<script type="text/javascript" id="www-widgetapi-script" src="https://s.ytimg.com/yts/jsbin/www-widgetapi-vflTj3NPM/www-widgetapi.js" async=""></script>*/
		var scr = $('<script />',{
		    type: 'text/javascript',
            id: 'www-widgetapi-script',
            src: 'https://s.ytimg.com/yts/jsbin/www-widgetapi-vflTj3NPM/www-widgetapi.js'
        });
